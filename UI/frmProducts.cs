...
namespace iResell.UI
{
    public partial class frmProducts : Form
    {
        ...
        {
            label89.Text = frmLogin.loggedIn;
        ...
        private void dgvProducts_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            lblDescription.Text = dgvProducts.Rows[rowIndex].Cells[4].Value.ToString();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            p.category = cmbCategory.Text;
            p.description = txtDescription.Text;
            p.rate = decimal.Parse(lblDescription.Text);
            p.added_date = DateTime.Now;
        ...
        private void exploiterStopBtn_Click(object sender, EventArgs e)
        {
            panel1.Show();
        }
